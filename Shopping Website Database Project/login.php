<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT EMAILADDRESS FROM CUSTOMER WHERE EMAILADDRESS = '$myusername' and PASSWORD = '$mypassword'";
   ...
   <body bgcolor = "#FFFFFF">
      ...
      <div align = "center">
         <div style = "width:600px; border: solid 1px #333333; " align = "center"; id = "container">
            <div  id = "title"><b>Customer Login</b></div>
				
            <div style = "margin:30px">
               
               <form action = "" method = "post">
                  <label>UserName  :</label><input type = "text" name = "username" autofocus="autofocus" class = "box"/><br /><br />
                  <label>Password  :</label><input type = "password" name = "password" class = "box" /><br/><br />
                  <input type = "submit" value = " Submit " id = "GenericButton"/>
                  <input type="reset" id = "GenericButton"/>
               </form>
                  <button onclick="window.location.href='newUser.php'" id = "GenericButton">Sign Up</button><br /><br />

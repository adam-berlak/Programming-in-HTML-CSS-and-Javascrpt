<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "DELETE FROM BILLINGADDRESS WHERE CUST_EMAIL='$myusername' AND SNUM='$mysnum' AND SNAME='$mysname' AND CITY='$mycity' AND PCODE='$mypcode';";
...
<html>
   ...
   <head>
      <title>Delete a Billing Address</title>
   ...
   <body bgcolor = "#FFFFFF">
      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b>Delete a Billing Address</b></div>
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "POST">
                  ...
                  <label>Postal Code  :</label><input type = "text" name = "PCODE" class = "box" pattern="[a-zA-Z0-9]{1,}" required title="Alphanumeric only"/><br/><br />
